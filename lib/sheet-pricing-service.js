...
async function readSheetRows({ appsScriptUrl, sheetUrl, sheetName, startRow, endRow, specificRows, fetchImpl = fetch }) {
    const rowSet = parseSpecificRows(specificRows);
...
function startBackgroundPricingJob({
    ...
    (async () => {
        ...
        try {
            ...
            const filteredMergedRows = rowSet
